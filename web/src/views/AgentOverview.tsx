...
export function AgentOverview() {
  ...
  return <section className="mb-8 rounded-xl border p-5 space-y-3">
    <div className="flex justify-between items-center"><h2 className="font-semibold">本机 AI 引擎</h2><Button variant="ghost" size="sm" onClick={load}>重新检测</Button></div>
    ...
    <p className="text-xs text-muted-foreground">安装检测不代表已经登录。新建 Bot 后扫码连接飞书，再为群选择工作目录。</p>
