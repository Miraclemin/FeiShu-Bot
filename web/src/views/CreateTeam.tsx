...
export function CreateTeam({onBack,onOpen}:{onBack:()=>void;onOpen:(profile:string)=>void}) {
 ...
 <p className="text-muted-foreground">独立组织者 + 新飞书群 + 本群共享协作手册。创建人是负责人，普通 Agent 加入后承担各自职责。</p>
 {!result&&<>
 ...
 <p className="text-xs text-muted-foreground">这是组织者执行任务的本机目录；其他 Agent 保留自己的工作目录。</p>
 </fieldset>
