import { discoverSkills, selectedSkills, skillPrompt } from '../workbench-skills';
...
export class ClaudeAdapter implements AgentAdapter {
  ...
  run(opts: AgentRunOptions): AgentRun {
    ...
    const systemPromptFile = writeSystemPromptFile(buildBridgeSystemPrompt(this.botIdentity) + (opts.skills ? skillPrompt(selectedSkills(opts.skills, discoverSkills(opts.cwd))) : ''));
    ...
    if (opts.skills) args.push('--disable-slash-commands');
