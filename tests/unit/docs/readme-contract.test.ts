...
async function readDocs(): Promise<string> {
  const [en, zh, upstreamEn, upstreamZh] = await Promise.all([
    readFile(new URL('../../../README.md', import.meta.url), 'utf8'),
    readFile(new URL('../../../README.zh.md', import.meta.url), 'utf8'),
    readFile(new URL('../../../docs/UPSTREAM-README.md', import.meta.url), 'utf8'),
    readFile(new URL('../../../docs/UPSTREAM-README.zh.md', import.meta.url), 'utf8'),
  ]);
  expect(en).toContain('docs/UPSTREAM-README.zh.md');
  return `${en}\n${zh}\n${upstreamEn}\n${upstreamZh}`;
}
